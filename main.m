...
% Prepara��o dos dados para treino.
data1 = [data1 samples];
data2 = [data2 samples];
data3 = [data3 samples];
...
for k = 1:K
    ...
    %% C�lculo da porcentagem de acerto da rodada.
...
plot(acertos, 'DisplayName', 'Acertos', 'MarkerSize', 20, 'Marker', ...
    '.', 'LineWidth', 2);
plot(mean(acertos)*ones(1,K), 'DisplayName', 'Acerto M�dio', ...
